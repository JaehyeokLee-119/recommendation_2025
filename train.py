...
parser.add_argument(
    "--batch_size", type=int, required=False, default=320, help="batch size"
)
parser.add_argument(
    "--train_file", type=str, required=True, help="batch size"
)
parser.add_argument(
    "--test_file", type=str, required=True, help="batch size"
)
parser.add_argument(
    "--profile", type=str, required=True, help="batch size"
)
...
data_files = {
    "train": args.train_file, # "datasets/Amazon/MoviesAndTV/train.jsonl" "datasets/TripAdvisor/train.jsonl"
    "test": args.test_file, #  "datasets/Amazon/MoviesAndTV/test.jsonl" "datasets/TripAdvisor/test.jsonl"
}
profile=args.profile # "user_profiles/amazon_profiles.json"
